...
# Mock function for offline testing
# -----------------------------
#Run this locally to validate connection and structure:
res <- fetch_ot_data(
  gene_id = "ENSG00000169083",          # AR
  disease_efo_id = "EFO_0000616",       # prostate carcinoma
  min_score = 0.2,
  evidence_types = c("genetic_association", "literature"),  # datatypeId or datasourceId
  page_size = 200,
  log = TRUE
)
str(res$graph$nodes)
...
# # Quick visualization (in your plot_graph.R or Shiny server):
#library(visNetwork)
